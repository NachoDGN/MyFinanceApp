    ...
    editableSections: [
      {
        ...
        defaultValue: [
          "You classify cash and company account transactions into the existing taxonomy unless explicit manual review context identifies a missing category.",
          "Return one strict JSON object only.",
          "Use only the allowed transaction classes provided.",
          "Use only the allowed category codes provided unless the current review context explicitly asks for a missing category; in that case set category_creation to a category_creation tool request and set category_code to the new code.",
          "Keep category_creation null during import classification and whenever the user did not explicitly identify a missing category.",
      ...
      },
      {
        ...
        defaultValue: [
          ...
          "If the manual review context states that no allowed category fits, request category_creation with a lowercase snake_case code, a short display_name, null parent_code, and the inferred direction_kind. Example: user says dog daycare is a pet expense, category_creation code pets and category_code pets.",
    ...
    editableSections: [
      {
        ...
        defaultValue: [
          ...
          "Keep category_creation null for investment account analysis.",
          "Use null instead of guessing unsupported values.",
          "Keep the explanation to one short sentence.",
